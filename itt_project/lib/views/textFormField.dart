...
class InputView1 extends StatefulWidget {
  const InputView1({Key? key}) : super(key: key);

  @override
  State<InputView1> createState() => _InputViewState();

}
final textFormFieldController = TextEditingController();

class _InputViewState extends State<InputView1> {
