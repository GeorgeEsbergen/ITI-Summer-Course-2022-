    ...
    return Scaffold(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    //     },
                    //     settings: const RouteSettings(arguments: {"wifeName":"Amira"})
                    //   ),
                    // );

                    Navigator.of(context).pushNamed(ExtraView.routeName);
                  },
                ),
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items:
            ...
            return BottomNavigationBarItem(
                icon: Icon(bNItem.icon), label: bNItem.label);
          }).toList(),
        ));
  }
}

class AheadCard extends StatefulWidget {
  const AheadCard({
    Key? key,
  ...
  @override
  State<AheadCard> createState() => _AheadCardState();
}

class _AheadCardState extends State<AheadCard> {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    print("ahead card has been created  at index ${widget.index}");
  }
  ...
  void dispose() {
    ...
    super.dispose();
    print("ahead card disposed at index ${widget.index}");
  }
  ...
  void didChangeDependencies() {
    ...
    print("ahead card did change called at index ${widget.index}");
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "in ${widget.duration.inDays} days",
              style: const TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 12,
